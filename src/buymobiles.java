 ...
 * @author XYZ
 */
public class buymobiles extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel8.setText("ONLINE PURCHASE FORM (MOBILE)");

        jButton1.setText("MOBILE CODE 1");
        ...
        jButton2.setText("MOBILE CODE 2");
        ...
        jButton3.setText("MOBILE CODE 3");
        ...
        jButton4.setText("MOBILE CODE 4");
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ...
        try
        {
            ...
            query="select * from buymob order by refno";
        ...
        refno.setText(" "+c);
            ...
            query="insert into buymob values('"+b+"','"+q+"','"+r+"','"+ ms+"',"+c+","+id+");";
        ...
        try
{
         ...
         query="select * from mymobcart where ccode=1;";
         rs=stmt.executeQuery(query);
        ...
        try
{
         ...
         query="select * from mymobcart where ccode=2;";
         rs=stmt.executeQuery(query);
        ...
        try
{
         ...
         query="select * from mymobcart where ccode=3;";
         rs=stmt.executeQuery(query);
        ...
        try
{
         ...
         query="select * from mymobcart where ccode=4;";
         rs=stmt.executeQuery(query);
