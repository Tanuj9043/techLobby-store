 ...
 * @author XYZ
 */
public class buycomputers extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel8.setText("ONLINE PURCHASE FORM (COMPUTER)");

        jButton1.setText("COMPUTER CODE 1");
        ...
        jButton2.setText("COMPUTER CODE 2");
        ...
        jButton3.setText("COMPUTER CODE 3");
        ...
        jButton4.setText("COMPUTER CODE 4");
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ...
        try
        {
            ...
            query="select * from buycom order by refno";
        ...
        refno.setText(""+c);
            ...
            query="insert into buycom values('"+b+"','"+q+"','"+r+"','"+ ms+"',"+c+","+id+");";
        ...
        try
{
         ...
         query="select * from mycomcart where ccode=1;";
         rs=stmt.executeQuery(query);
        ...
        try
{
         ...
         query="select * from mycomcart where ccode=2;";
         rs=stmt.executeQuery(query);
    ...
    try
{
         ...
         query="select * from mycomcart where ccode=3;";
         rs=stmt.executeQuery(query);
    ...
    try
{
         ...
         query="select * from mycomcart where ccode=4;";
         rs=stmt.executeQuery(query);
