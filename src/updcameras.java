 ...
 * @author XYZ
 */
public class updcameras extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        qua.setFont(new java.awt.Font("Tahoma", 0, 24)); // NOI18N
        ...
        resol.setFont(new java.awt.Font("Tahoma", 0, 24)); // NOI18N
        ...
        mktprice.setFont(new java.awt.Font("Tahoma", 0, 24)); // NOI18N

        disc.setFont(new java.awt.Font("Tahoma", 0, 24)); // NOI18N
        ...
        net.setFont(new java.awt.Font("Tahoma", 0, 24)); // NOI18N

        updcamera.setFont(new java.awt.Font("Tahoma", 0, 24)); // NOI18N
        ...
        jLabel8.setText("UPDATE FORM OF CAMERAS");
        ...
        jLabel9.setText("CAMERA CODE");

        ccod.setFont(new java.awt.Font("Tahoma", 0, 24)); // NOI18N
    ...
    private void updcameraActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updcameraActionPerformed
        ...
        try
        {
            ...
            query="update mycamcart set bname='"+b+"',qual='"+q+"',resol='"+r+"',memory='"+ms+"',mprice="+m+",disc="+d+",netprice="+n+" where ccode="+c+";";
...
try
{
         ...
         query="select * from mycamcart where ccode="+c+";";
