 ...
 * @author XYZ
 */
public class updmobiles extends javax.swing.JFrame {
    ...
    private void updcameraActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updcameraActionPerformed
        ...
        try
        {
            ...
            query="update mymobcart set bname='"+b+"',qual='"+q+"',resol='"+r+"',memory='"+ms+"',mprice="+m+",disc="+d+",netprice="+n+" where ccode="+c+";";
...
try
{
         ...
         query="select * from mymobcart where ccode="+c+";";
